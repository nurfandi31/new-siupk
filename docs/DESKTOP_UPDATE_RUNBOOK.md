...
4. Setelah selesai, perbarui konfigurasi server:
   ...
   - `DESKTOP_DOWNLOAD_URL=https://github.com/its-enpii/new_siupk/releases/latest/download/siupk%20Next%20Desktop%20Setup%201.2.0.exe`
   - `DESKTOP_RELEASE_NOTES_URL=https://github.com/its-enpii/new_siupk/releases/latest`
...
## Catatan teknis
- Feed `electron-updater` memakai provider generic dengan URL `https://github.com/its-enpii/new_siupk/releases/latest/download`, sehingga `latest.yml` dibaca otomatis dari release terbaru.

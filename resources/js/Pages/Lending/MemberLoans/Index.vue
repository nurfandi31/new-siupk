    ...
    <AuthenticatedLayout>
        <div class="mx-auto max-w-7xl space-y-6 pb-12">
            <AppPageHeader
                ...
                subtitle="Pantau pergerakan pinjaman perorangan dari pengajuan hingga pelunasan."
                :breadcrumbs="[{ label: 'Pinjaman Individu', href: '/lending/member-loans' }, { label: tab.charAt(0).toUpperCase() + tab.slice(1) }]"
                tone="primary"
            >
                <template #actions>

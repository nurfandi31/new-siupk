...
const baseUrl = '/lending/reports/verifications';
const pdfUrl = '/lending/reports/verifications/pdf';
const excelUrl = '/lending/reports/verifications/excel';
...
<template>
    <Head title="Daftar Verifikasi" />
    <AuthenticatedLayout>
        <div class="mx-auto max-w-7xl space-y-6">
            <header class="flex flex-wrap items-end justify-between gap-3">
                <div>
                    <p class="text-xs font-bold uppercase tracking-[0.18em] text-on-surface-variant">Pelaporan Pinjaman</p>
                    <h1 class="mt-1 text-2xl font-bold text-primary">Daftar Verifikasi Pinjaman</h1>
                    <p class="mt-1 text-sm text-on-surface-variant">
                        Pinjaman yang sedang dalam proses verifikasi.
            ...
            <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                <AppCard>
                    <p class="text-xs font-bold uppercase tracking-wider text-on-surface-variant">Jumlah Verifikasi</p>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-3 py-2 text-center">
                                <AppBadge tone="info">{{ row.status_label }}</AppBadge>
                            </td>
                            <td class="px-3 py-2 text-center">
                    ...
                    <tfoot v-if="rows.length > 0" class="bg-surface-container-low">
                        <tr class="border-t-2 border-outline font-semibold">
                            <td colspan="6" class="px-3 py-2.5">TOTAL VERIFIKASI ({{ totals.count }})</td>

...
function apply(): void {
    router.get(
        '/lending/reports/weekly/lpp-kelompok',
        {
...
const pdfUrl = computed(() => {
    ...
    return `/lending/reports/weekly/lpp-kelompok/pdf?${q.toString()}`;
});
...
<template>
    <Head title="LPP Mingguan Kelompok" />
        ...
        <div class="mx-auto max-w-7xl space-y-6">
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-1 text-2xl font-bold text-primary">LPP Mingguan — Rincian Kelompok</h1>
            ...
            <AppCard class="p-4 bg-surface-container-low">
                <div class="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div class="text-xs text-on-surface-variant">
                        Subjek: <span class="font-semibold text-primary">Kelompok</span>
                    </div>
                </div>
            </AppCard>
                        ...
                        <tbody class="divide-y divide-outline-variant/20">
                            <template v-for="v in prod.villages" :key="v.village_name">
                                ...
                                <tr v-for="loanRaw in v.loans" :key="(loanRaw as Record<string, unknown>).loan_id as number" class="hover:bg-surface-variant/10">
                                    ...
                                    <td class="p-2.5 text-center">{{ asLoanRow(loanRaw).pemanfaat_count ?? 1 }}</td>

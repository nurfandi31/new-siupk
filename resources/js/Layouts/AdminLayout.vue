...
<template>
    <div class="min-h-screen bg-surface">
        ...
        >
            ...
            <button
                type="button"
                class="absolute top-5 -right-3 z-10 grid size-8 place-items-center rounded-full border border-outline-variant bg-surface text-on-surface shadow-sm transition hover:bg-surface-container hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-container lg:top-7"
        ...
        <header
            class="sticky top-0 z-30 flex h-16 items-center border-b border-outline-variant bg-surface px-4 transition-all duration-300 lg:px-6"
        ...
        >
            ...
            <div class="ml-auto flex items-center gap-1 pl-3">
                ...
                <Link
                    href="/profile"
                    class="ml-1 flex shrink-0 items-center gap-2 rounded-full border border-outline-variant bg-surface-container-lowest py-1 pl-1 pr-3 transition hover:bg-surface-container-low hover:border-primary/40"

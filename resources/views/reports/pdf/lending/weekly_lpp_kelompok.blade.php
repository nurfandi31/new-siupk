            ...
            <tr>
                <td align="center">
                    <div style="font-size: 18px; font-weight: bold;">
                        DAFTAR PERKEMBANGAN PIUTANG (LPP) MINGGUAN RINCIAN KELOMPOK — {{ strtoupper($prod['product_name']) }} ({{ $prod['product_code'] }})
                    </div>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 8px; table-layout: fixed;">
                ...
                @foreach ($prod['villages'] as $v)
                    ...
                    @foreach ($v['loans'] as $loan)
                        <tr>
                            ...
                            <td class="l b" align="center">{{ $loan['pemanfaat_count'] ?? 1 }}</td>
                    ...
                    <tr style="background: rgb(242,242,242); font-weight: bold;">
                        ...
                        <td class="l b" align="center">{{ $v['subtotal']['pemanfaat_count'] ?? 0 }}</td>
            ...
            <tfoot>
                <tr style="background: rgb(232,232,232); font-weight: bold;">
                    ...
                    <th class="t l b" align="center">{{ $prod['totals']['pemanfaat_count'] ?? 0 }}</th>

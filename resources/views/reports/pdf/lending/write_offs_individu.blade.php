...
@section('content')
        ...
        <tr>
            <td align="center">
                <div style="font-size: 18px; font-weight: bold;">
                    DAFTAR PINJAMAN DIHAPUSBUKUKAN — INDIVIDU
                </div>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 7.5px; table-layout: fixed;">
        <thead>
            <tr style="background: rgb(230, 230, 230); font-weight: bold; text-align: center;">
                ...
                <th class="t l b" width="15%">Peminjam (NIK)</th>
                <th class="t l b" width="10%">Desa</th>
                <th class="t l b" width="11%">Kelompok</th>
                <th class="t l b" width="9%">Pokok</th>
                <th class="t l b" width="9%">Sisa Pokok</th>
                <th class="t l b" width="9%">Cadangan CKPN</th>
                <th class="t l b" width="9%">Nilai Bersih</th>
                <th class="t l b" width="7%">Tgl Hapus</th>
                <th class="t l b r" width="6%">Alasan</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="l b">
                        {{ $row['member_name'] }}
                        @if (! empty($row['nik']))
                            <div style="color:#718096; font-size: 7px;">NIK: {{ $row['nik'] }}</div>
                        @elseif (! empty($row['member_number']))
                            <div style="color:#718096; font-size: 7px;">{{ $row['member_number'] }}</div>
                        @endif
                    </td>
                    ...
                    <td class="l b">
                        ...
                        @if (! empty($row['group_code']))
                            <div style="color:#718096; font-size: 7px;">{{ $row['group_code'] }}</div>
                        @endif
                    </td>
            ...
            @empty
                <tr>
                    <td class="l b r" colspan="11" align="center" style="padding: 18px;">
        ...
        <tfoot>
            <tr style="background: rgb(232,232,232); font-weight: bold;">
                <th class="t l b" colspan="5" align="left">TOTAL ({{ $totals['count'] ?? 0 }} pinjaman)</th>

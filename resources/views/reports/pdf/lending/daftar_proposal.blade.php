...
@section('content')
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 11px; margin-bottom: 10px;">
        <tr>
            <td align="center">
                <div style="font-size: 18px; font-weight: bold;">{{ strtoupper($stage_title ?? 'DAFTAR PROPOSAL PINJAMAN') }}</div>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 8.5px; table-layout: fixed;">
        <thead>
            <tr style="background: rgb(230, 230, 230); font-weight: bold; text-align: center;">
                ...
                <th class="t l b" width="10%">{{ $stage_date_label ?? 'Tgl Pengajuan' }}</th>
        ...
        <tfoot>
            <tr style="background: rgb(232,232,232); font-weight: bold;">
                <th class="t l b" colspan="6" align="left">TOTAL PROPOSAL ({{ $totals['count'] ?? 0 }})</th>
    ...
    <p style="font-size: 8px; color: #4a5568; margin-top: 8px;">
        Keterangan: {{ $stage_date_label ?? 'Tgl Pengajuan' }} dihitung berdasarkan kolom
        <code>proposed_at</code> pada tabel loans. Pinjaman kelompok menggunakan desa dari
        group; pinjaman individu menggunakan desa dari anggota.
    </p>
@endsection

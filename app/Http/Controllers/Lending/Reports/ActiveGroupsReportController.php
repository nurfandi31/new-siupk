...
use App\Domain\Lending\Services\Reports\ActiveGroupsReportService;
use App\Models\User;
...
final class ActiveGroupsReportController
{
    public function __construct(
        private readonly PermissionChecker $permissions,
        private readonly ActiveGroupsReportService $service,
    ...
    public function index(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('Lending/Reports/ActiveGroups', [
    ...
    public function pdf(Request $request): Response|StreamedResponse
    {
        ...
        return $this->pdf->stream(
            'reports.pdf.lending.active_groups',
            $data,
            sprintf('kelompok-aktif-%04d-%02d.pdf', $year, $month),
            'landscape',
        );
    }

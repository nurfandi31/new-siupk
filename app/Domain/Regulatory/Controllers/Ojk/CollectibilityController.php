...
use App\Domain\Regulatory\Services\CollectibilityOjkService;
use App\Models\User;
 ...
 *   GET  /regulatory/ojk/collectibility         → Inertia page
 *   GET  /regulatory/ojk/collectibility/pdf     → Landscape PDF stream
 *
 * Permission: `regulatory.view`.
 */
final class CollectibilityController
{
    public function __construct(
        private readonly PermissionChecker $permissions,
        private readonly CollectibilityOjkService $report,
    ...
    public function index(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('Regulatory/Ojk/Collectibility', [
            ...$payload,
    ...
    public function pdf(Request $request): Response|StreamedResponse
    {
        ...
        try {
            ...
            abort(422, 'Gagal membangun laporan Kolektibilitas OJK: '.$e->getMessage());
        }

        return $this->pdf->stream(
            'reports.pdf.ojk.collectibility',
            $data,
            sprintf('kolektibilitas-ojk-%04d-%02d.pdf', $year, $month),
            'landscape',
        );
    }

...
use App\Domain\Regulatory\Services\PaidIndividuLoansService;
use App\Models\User;
 ...
 *   GET  /regulatory/ojk/paid-individu         → Inertia page
 *   GET  /regulatory/ojk/paid-individu/pdf     → Landscape PDF stream
 *
 * Permission: `regulatory.view`.
 */
final class PaidIndividuLoansController
{
    public function __construct(
        private readonly PermissionChecker $permissions,
        private readonly PaidIndividuLoansService $service,
    ...
    public function index(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('Regulatory/Ojk/PaidIndividu', [
    ...
    public function pdf(Request $request): Response|StreamedResponse
    {
        ...
        return $this->pdf->stream(
            'reports.pdf.ojk.paid_individu',
            $data,
            sprintf('drpli-pinjaman-lunas-individu-%04d-%02d.pdf', $year, $month),
            'landscape',
        );
    }

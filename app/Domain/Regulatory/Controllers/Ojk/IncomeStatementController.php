...
use App\Domain\Regulatory\Services\OjkIncomeStatementService;
use App\Models\User;
 ...
 *   GET  /regulatory/ojk/income-statement      → Inertia page
 *   GET  /regulatory/ojk/income-statement/pdf  → Portrait PDF stream
 *
...
final class IncomeStatementController
{
    public function __construct(
        ...
        private readonly OjkIncomeStatementService $service,
    ...
    public function index(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('Regulatory/Ojk/IncomeStatement', [
    ...
    public function pdf(Request $request): Response|StreamedResponse
    {
        ...
        return $this->pdf->stream(
            'reports.pdf.ojk.income_statement',
            $data,
            'laba-rugi-ojk-'.$suffix.'.pdf',
            'portrait',
        );
    }
